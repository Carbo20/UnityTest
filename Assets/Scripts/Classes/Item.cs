...
public class Item
{
    ...
    enum BonusType { STREN, INTEL, AGI, VITAL, HEALTH, };
    ...
    void GenerateItem(int level, int magicFind)
    {
        ...
        //rand pour determiner quel QUALITE d'item ce sera : Nomral : 0 bonus, magic : 1 à 2 bonus, legendaire 3 à 4 bonus + un effet
        ...
        int itemSlotType = UnityEngine.Random.Range(0, 7); // Type de slot d'item /SlotType : HEAD, CHEST, HANDS, LEGS, FEET, ONEHAND, TWOHANDS    ///PB : 2 chance sur 7 d'avoir une arme et 5 / 7 d'avoir une armure
